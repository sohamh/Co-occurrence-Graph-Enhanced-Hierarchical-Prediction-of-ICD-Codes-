...
########### The database ###########
    dict = open(
        '/mnt/data2/soha/codes/caml-mimic-master_Soha_01/mapping/ICD10-ICD9-codes-conversion-master/ICD_9_10_d_v1.1.csv')
    try:
        dict = open('/mnt/data2/soha/codes/caml-mimic-master_Soha_01/mapping/ICD10-ICD9-codes-conversion-master/ICD_9_10_d_v1.1.csv')
