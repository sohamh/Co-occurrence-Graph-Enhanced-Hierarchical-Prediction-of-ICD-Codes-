...
#     # model_dir='/home/soha/codes/caml_transfer_icd/saved_models/conv_attn_Jan_30_15_28_47/model_best_f1_micro.pth'
#     # args.test_model = '/home/soha/codes/caml_transfer_icd/saved_models/conv_attn_Jan_30_15_28_47/model_best_f1_micro.pth'#'%s/model_best_%s.pth' % (model_dir, args.criterion)
#     args, model, optimizer, scheduler, params, dicts = main.init(args)
#
#     if(args.from_checkpoint):
#         pdict=torch.load(args.checkpoint)
#         del pdict['U.weight']
...
#         model.load_state_dict(cdict)
#
#     metrics_te = main2.test(model, args.Y, 1 , args.data_path, "test", args.gpu, args.version, unseen_code_inds, dicts, samples,
#                       model_dir, True)
#
#     one_epoch(model, optimizer, scheduler, args.Y, epoch, args.n_epochs, args.batch_size, args.data_path,
